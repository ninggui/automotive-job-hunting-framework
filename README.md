...
[SkillHub 在线安装](https://skillhub.cn/skills/automotive-job-hunting-framework) · [快速使用](#快速使用) · [核心能力](#核心能力) · [使用边界](#使用边界)
...
```text
使用 automotive-job-hunting-framework 技能。
这是待处理内容，直接执行。
```
...
- 涉及「automotive-job-hunting-framework」的场景任务
- 需要复用已验证方法论的工作
- 批量/复杂任务中的专项环节
